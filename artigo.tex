%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Modelo.tex  (Serve para escrever Monografias - Disserta��o - Tese)                      %%
%%                                                                                         %%
%% Idealizado em  06/12/2012 - por:  Emivan Ferreira da Silva (emivan@unemat.br)           %%
%%                                   S�rgio Azevedo de Oliveira (grilo@dee.feis.unesp.br)  %%
%%                                                                                         %%
%%              Este documento foi idealizado para auxiliar os alunos do                   %%
%%                      PPGEE da UNESP - C�mpus de Ilha Solteira.                          %%  %%                                                                                         %%
%%                                                                                         %%
%%            Maiores informa��es, favor entrar em contato com os autores.                 %%
%%                                                                                         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\author{Autor1\inst{1},\\ Autor2\inst{2},\\ Orientador\inst{3}, \\Coorientador (se houver)\inst{4} }

\begin{document} 

\maketitle

\begin {resumo} %centralizar os titutlos
...
{\footnotesize\center{\small Fonte: \cite{kn}}} %citar e mudar fonte
\label{fig1}
\end{figure} 
